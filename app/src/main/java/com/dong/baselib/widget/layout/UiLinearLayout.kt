...
) : LinearLayout(context, attrs, defStyleAttr)
{
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            cornerRadius = getDimension(R.styleable.StyleView_cornerRadius, 0f)
            stWidth = getDimension(R.styleable.StyleView_strokeWidth, 0f)
            stColorDark = getColor(R.styleable.StyleView_stColorDark, Color.BLACK)
            stColorLight = getColor(R.styleable.StyleView_stColorLight, Color.BLACK)
            bgColorDark = getColor(R.styleable.StyleView_bgColorDark, Color.TRANSPARENT)
            bgColorLight =
                getColor(R.styleable.StyleView_bgColorLight, Color.TRANSPARENT)
            bgGradientStart =
                getColor(R.styleable.StyleView_bgGradientStart, Color.TRANSPARENT)
            bgGradientCenter =
                getColor(R.styleable.StyleView_bgGradientCenter, Color.TRANSPARENT)
            bgGradientEnd =
                getColor(R.styleable.StyleView_bgGradientEnd, Color.TRANSPARENT)
            isGradient = bgGradientStart != Color.TRANSPARENT && bgGradientEnd != Color.TRANSPARENT
            isDistance = getBoolean(R.styleable.StyleView_strokeDistance, false)
            distanceSpace = getDimension(R.styleable.StyleView_distanceSpace, 10f)

            val gradient = getString(R.styleable.StyleView_strokeGradient)
            ...
            gradientOrientation =
                when (getInt(R.styleable.StyleView_bgGdOrientation, 0)) {
            ...
            strokeGradientOrientation =
                when (getInt(R.styleable.StyleView_strokeGdOrientation, 6)) {
